...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        button{padding:10px 16px;border-radius:10px;font-weight:600;font-size:12px;cursor:pointer;border:none;color:white;transition:all .2s}
        button:hover{transform:translateY(-2px);opacity:.9}
        .btn-gas{background:#F59E0B}.btn-gas2{background:#EA580C}.btn-gas3{background:#DC2626}
        .btn-temp{background:#F97316}.btn-temp2{background:#EA580C}
        .btn-panic{background:#EF4444}.btn-reset{background:#10B981}.btn-view{background:#6366F1}
        #result{background:#0A0D14;border:1px solid #262D3D;border-radius:12px;padding:16px;font-family:'Courier New',monospace;font-size:12px;color:#10B981;max-height:300px;overflow-y:auto;white-space:pre-wrap;display:none}
        ...
        .method{padding:4px 8px;border-radius:5px;font-size:10px;font-weight:800;letter-spacing:.5px;min-width:52px;text-align:center}
        .get{background:rgba(16,185,129,0.2);color:#10B981}.post{background:rgba(249,115,22,0.2);color:#F97316}
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>KitchenGuard API v1.0 · SQLite · <a href="https://kitchenguard-six.vercel.app">Web App</a> · <a href="https://github.com/AleRodriguezCruz/KitchenGuard_API">GitHub</a></p>
        </div>
    </div>
    <script>
